...
public class WebSocketClientHandler extends TextWebSocketHandler implements ICallbackClientHandler, InitializingBean {
	...
	public void sendMessage(Integer messageType, String messageSubtype, Object ob) throws OntimizeJEEException {
		try {
			TextMessage textMessage = new TextMessage(new CallbackWrapperMessage(messageType, messageSubtype, ob).serialize());
	...
	private void fireMessageEvent(CallbackWrapperMessage wrappedMessage) {
